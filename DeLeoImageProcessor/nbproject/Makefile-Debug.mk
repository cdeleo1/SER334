...
${OBJECTDIR}/BmpProcessor.o: BmpProcessor.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BmpProcessor.o BmpProcessor.c

${OBJECTDIR}/DeLeoImageProcessor.o: DeLeoImageProcessor.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeLeoImageProcessor.o DeLeoImageProcessor.c

${OBJECTDIR}/PixelProcessor.o: PixelProcessor.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PixelProcessor.o PixelProcessor.c

${OBJECTDIR}/PpmProcessor.o: PpmProcessor.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PpmProcessor.o PpmProcessor.c
